...
test: ## Run unit tests across workspace
	go test -v ./... ./adapter/chi/... ./adapter/caddy/... ./storage/redis/...
...
bench: ## Run modernized b.Loop() memory allocation benchmarks
	go test -benchmem -bench=. -run=^$ ./... ./esi/... ./adapter/chi/... ./adapter/caddy/... ./storage/redis/...

vet: ## Run Go static analysis across workspace
	go vet ./... ./adapter/chi/... ./adapter/caddy/... ./storage/redis/...
	go work sync
